...
TASKS_INSTRUCTION = "You will receive a collection of projects, and your task is to plan their execution in the next project phase for the group. Prioritise the tasks according to their size, priority, and assigned members, and suggest potentially useful collaborations. Dedicate a section in the beginning to who should talk to whom."

TASKS_INSTRUCTION_INDIVIDUAL = "You will receive a collection of tasks of an individual member of a group, and your task is to plan the next project phase for this member. Prioritise the tasks according to their size / priority, and suggest potentially useful collaborations."
